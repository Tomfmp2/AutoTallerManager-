...
public class PublicRegisterCommand : IRequest<Result<int>>
{
...
public class PublicRegisterCommandHandler : IRequestHandler<PublicRegisterCommand, Result<int>>
{
    private readonly IApplicationDbContext _db;

    public PublicRegisterCommandHandler(IApplicationDbContext db)
    {
        _db = db;
    }

    public async Task<Result<int>> Handle(PublicRegisterCommand request, CancellationToken cancellationToken)
    {
